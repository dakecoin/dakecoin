...
* DakeCoin.conf: contains configuration settings for DakeCoind or DakeCoin-qt
* DakeCoind.pid: stores the process id of DakeCoind while running
...
* debug.log: contains debug information and general logging generated by DakeCoind or DakeCoin-qt
