DakeCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/DakeCoin/files/DakeCoin/DakeCoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the DakeCoin
...
New/changed settings (command-line or DakeCoin.conf file)
--------------------------------------------------------
