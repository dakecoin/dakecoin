DakeCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/DakeCoin/files/DakeCoin/DakeCoin-0.5.4/
...
http://gitorious.org/DakeCoin/DakeCoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix DakeCoin-Qt notifications under Growl 1.3.
Increase required age of DakeCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDakeCoin properly when installing DakeCoin-Qt over it. (Windows)
