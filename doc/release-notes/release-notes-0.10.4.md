DakeCoin Core version 0.10.4 is now available from:

  <https://DakeCoin.org/bin/DakeCoin-core-0.10.4/>
...
- #6953 `43c2789` Split DakeCoin-tx into its own package
- #6953 `dfe0d4d` Include DakeCoin-tx binary on Debian/Ubuntu
