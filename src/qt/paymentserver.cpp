...
const QString BITCOIN_IPC_PREFIX("DakeCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click DakeCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start DakeCoin: click-to-pay handler");
    else
...
{
    // clicking on DakeCoin: URLs creates FileOpen events on the Mac:
