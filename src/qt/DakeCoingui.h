...
/**
  DakeCoin GUI main class. This class represents the main window of the DakeCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DakeCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DakeCoinGUI(QWidget *parent = 0);
    ~DakeCoinGUI();
