...
class BIP66Test(DakeCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # DakeCoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and DakeCoind produces more specific reject
            # reasons.
