...
By default, DakeCoind will dump mempool on shutdown and
...
class MempoolPersistTest(DakeCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give DakeCoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent DakeCoind from writing mempool.dat to disk. Verify that `savemempool` fails")
